...
const PROVIDER_TEMPLATES: Record<string, { name: string; baseUrl: string; apiType: string; defaultModel: string }> = {
  ...
  moonshot:   { name: 'Moonshot / Kimi',   baseUrl: 'https://api.moonshot.cn/v1',                       apiType: 'openai-completions', defaultModel: 'kimi-k2.6' },
  ...
  minimax:    { name: 'MiniMax / 海螺',     baseUrl: 'https://api.minimax.chat/v1',                       apiType: 'openai-completions', defaultModel: 'minimax-m3' },
  doubao:     { name: '豆包 (Doubao)',       baseUrl: 'https://ark.cn-beijing.volces.com/api/v3',          apiType: 'openai-completions', defaultModel: 'seed-2.0-pro' },
  hunyuan:    { name: '腾讯混元 (Hunyuan)',   baseUrl: 'https://api.hunyuan.cloud.tencent.com/v1',         apiType: 'openai-completions', defaultModel: 'hunyuan-3.0' },
