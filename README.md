...
```bash
# macOS / Linux
curl -fsSL https://raw.githubusercontent.com/jwcode-ai/jwcode/main/install.sh | sh

# Windows
powershell -ExecutionPolicy ByPass -c "irm https://raw.githubusercontent.com/jwcode-ai/jwcode/main/install.ps1 | iex"
```
...
- 📖 [完整文档](docs/)
- 💬 微信群 / Discord（建设中）
- 🐛 [Issues](https://github.com/jwcode-ai/jwcode/issues)
